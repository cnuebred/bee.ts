...
const base_style = () => {
    const bee = new bee_1.Bee('cube_style');
    bee.add(`@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400&display=swap'); body{font-family: 'Montserrat', sans-serif;}`, 'style');
    bee.add(`::-webkit-scrollbar {
        width: 7.5px;
        height: 7.5px
      }
